...
description: Reviews Korean text without modifying it. Reports AI 가능성, 신뢰도 and evidence with the ko-diagnose procedure. Use when asked to review or check Korean writing.
...
Use the ko-diagnose skill's procedure to report AI 가능성, 신뢰도 and evidence for the text you are given. Do not modify the text. Return the report in the upstream output format.
