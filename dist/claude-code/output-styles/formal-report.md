---
name: formal-report
description: Korean output policy for documents delivered to the user (fluent-korean, not-coding variant, honorific block). Not forced; see the install notes.
---
