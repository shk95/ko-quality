...
**`AGENTS.md` 후보 한 줄.** 시대 01의 리뷰 §D가 heredoc 규칙을 그렇게 더했듯이, 이 단계도 규칙 하나를 벌었습니다 — **하네스의 동작을 설계 문서에 쓰기 전에 한 번 돌려 본다.** 문서가 말하는 것과 도구가 하는 것은 달랐고, 다섯 번 다 그랬습니다. 규칙은 리뷰에서 더하는 것이라 여기서는 후보로만 적어 둡니다.
